...
**Type:** foundation  
**Region:** US  
**Site:** <https://chanzuckerberg.com/science/programs-resources/virtual-cells-initiative/>  

## TL;DR

Substrate + model shipper (TranscriptFormer, rBio); breaks substrate-only stereotype.
